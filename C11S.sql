...
SELECT * FROM emarket.productos WHERE UnidadesStock < NivelReorden AND UnidadesPedidas = 0;
...
SELECT Contacto, Direccion, Telefono FROM emarket.clientes WHERE Contacto LIKE 'C%';
...
SELECT Ciudad, Contacto AS 'Nombre y Apellido', Titulo As Puesto FROM emarket.clientes WHERE Ciudad = 'Madrid';
...
SELECT * FROM emarket.empleados WHERE Apellido = 'Buchanan';
